...
<body style="background-color: #f0f0f0; font-family: Arial, sans-serif; color: #1a1a1a;">
    <header id="header">
        <nav class="bg-white border-gray-300">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <a href="http://localhost/dashboard/ProyectoFinal/views/usuario/registro.php" class="text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2 text-center">
                        Registrarse
                    </a>
